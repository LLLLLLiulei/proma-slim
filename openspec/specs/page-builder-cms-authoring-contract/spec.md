...
定义 `page-builder` 中 `cms-catalog` / `cms-content` 作者态写法的 canonical contract，使运行时、正式 apply、validator、自动 handoff、default skills 与默认 guidance 统一消费同一份 CMS authoring 能力边界。
