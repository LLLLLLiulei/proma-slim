...
export function HomePage(): React.ReactElement {
  ...
  return (
    <div className="page-builder-home-shell flex min-h-[100dvh] items-center justify-center px-4 py-8 sm:px-6">
      ...
      <div className="page-builder-home-content mx-auto flex w-full max-w-[1120px] flex-col items-center gap-8">
